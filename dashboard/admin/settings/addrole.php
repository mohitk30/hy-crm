         ...
         <div id="main-container-div" class="d-flex flex-row">
                ...
                <div id="right-container">
                                    ...
                                    <div class="right-container-header" >
                                          <div class="username-position">Home > Settings > Configure Roles</div>
                                    ...
                                    <div class="main-content-settings-profile">
                                      <!-- Admin profile settings -->
                                                  ...
                                                  <div class="right-form-div">
                                                              <div class="w-100 p-1"> <strong>Add a New Role</strong> </div>
                                                              <div class="line-div"></div>
                                                                    ...
                                                                    <div class="complete-account-profile-div" >
                                                                          ...
                                                                          <div class="input-group mb-3 mx-2  w-100">
                                                                                     
                                                                                    <input placeholder="Enter a new role" type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
