         ...
         <div id="main-container-div" class="d-flex flex-row">
                ...
                <div id="right-container">
                                    ...
                                    <div class="right-container-header" >
                                          <div class="username-position">Home > Settings > Acknowledge SMS</div>
                                    ...
                                    <div class="main-content-settings-profile">
                                      <!-- Admin profile settings -->
                                                  ...
                                                  <div class="right-form-div">
                                                              <div><strong>Acknowledge SMS</strong></div>
                                                                    ...
                                                                    <div class="complete-account-profile-div" >
                                                                          ...
                                                                          <div class="mx-2 mt-3"> 
                                                                              ...
                                                                              <div class="d-flex flex-row">
                                                                                <div>Send Promotional SMS to users?</div>
                                                                                    <div class="mx-2">
                                                                                    <input class="mt-2" name="input-for-sms" type="checkbox" value="1"  >
                                                                                    </div>
                                                                              </div>

                                                                              <div class="d-flex flex-row mt-3" >6 Digit Sender ID<span class="red-asterick" >*</span>  <input type="text" class="form-control w-50 mx-5" id="basic-url" aria-describedby="basic-addon3"></div>
                                                                               
                                                                              <div class="d-flex flex-row mt-3">
                                                                                <div>Promotional SMS <span class="red-asterick" >*</span></div>
                                                                                <div class="w-50 mx-5" >  <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea></div>
                                                                              </div>
