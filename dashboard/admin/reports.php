...
<!-- user div -->
         ...
         <div id="right-container">
                  ...
                  <div class="username-position">Home > Reports</div>
                  ...
                  <div class="main-content-dashboard">
                    <!-- report info -->
                            ...
                            <div class="d-lg-flex p-4 main-heading-in-reports-section">
                              <!-- date selector div -->

                                    <div class="w-lg-25 p-3 d-flex">
                                    <input type="date" class="form-control mx-1" id=" " name=" " placeholder="Start date">
                                    <input type="date" class="form-control mx-1" id=" " name=" " placeholder="Start date">
                                         
                                    </div>

                                    <div class="text-center w-lg-75 px-lg-5 main-bold-section-for-report">
                                      HY-CRM Report<br> 
                                      username
                                    </div>
                            ...
                            <div class="d-lg-flex">
                              ...
                              <div class="lead-by-section-divs">
                              Leads by Source
                            ...
                            <div>
                              <!-- two tables div -->
                                  ...
                                  <div class="leads-by-source-table" >
                                    <div class="text-center">Leads by Source & Status</div>

                                        <div class="report-main-table-div mt-2 p-2">
                                             <!-- main table div -->
                                  ...
                                  <div class="leads-by-source-table" >
                                    <div class="text-center">Leads by Facebook Campaigns</div>
                                            ...
                                            <table id=" " class="table table-bordered">
                                                <thead>
                                                  <tr>
                                                    ...
                                                    <th scope="col">Existing costumer </th>
                                                    <th scope="col">Future leads</th>
                                  ...
                                  <div class="leads-by-source-table" >
                                    <div class="text-center">Leads by Google Campaigns</div>
