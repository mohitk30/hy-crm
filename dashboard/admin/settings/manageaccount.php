         ...
         <div id="main-container-div" class="d-flex flex-row">
                ...
                <div id="right-container">
                                    ...
                                    <div class="right-container-header" >
                                          <div class="username-position">Home > Settings > Admin Profile</div>
                                    ...
                                    <div class="main-content-settings-profile">
                                      <!-- Admin profile settings -->
                                                  ...
                                                  <div class="right-form-div">
                                                              <div><strong>Admin Profile</strong></div>
                                                              <div class="line-div"></div>
                                                                    ...
                                                                    <!-- personal -->
                                                                          <div class="mt-4"><strong>Personal Info</strong></div>
                                                                          <div class="line-div"></div>
                                                                          <!-- name and other info -->
                                                                          <div>
                                                                                <div class="input-group mb-3 mx-2  w-75">
                                                                                    <div class="input-group-prepend">
                                                                                      <span class="input-group-text" id="basic-addon3">Name<span class="red-asterick" >*</span></span>
                                                                                    </div>
                                                                                    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                                                                                  </div>
                                                                                  <div class="input-group mb-3 mx-2  w-75">
                                                                                    <div class="input-group-prepend">
                                                                                      <span class="input-group-text" id="basic-addon3">Phone<span class="red-asterick" >*</span></span>
                                                                                    </div>
                                                                                    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                                                                                  </div>
                                                                                  <div class="input-group mb-3 mx-2  w-75">
                                                                                    <div class="input-group-prepend">
                                                                                      <span class="input-group-text" id="basic-addon3">Email<span class="red-asterick" >*</span></span>
                                                                                    </div>
                                                                                    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                                                                                  </div>
                                                                    ...
                                                                    <!-- site -->
                                                                          <div class="mt-4"><strong>Website Info</strong></div>
                                                                          <div class="line-div"></div>
                                                                          <!-- info about site icon and name -->
                                                                          <div>
                                                                                  <div class="input-group mb-3 mx-2  w-75">
                                                                                    <div class="input-group-prepend">
                                                                                  ...
                                                                                  <div class="input-group mb-3 mx-2  w-75">
                                                                                    <div class="input-group-prepend">
                                                                                      <span class="input-group-text" id="basic-addon3">Brand Image</span>
                                                                                    </div>
                                                                                    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                                                                                  </div>

                                                                                  <div class="mt-2 mx-2 brand-image-preview">
                                                                                    <!-- brand image preview  div -->
                                                                                  </div>

                                                                                  <div class="line-div mt-2"></div>

                                                                                  <div class="save-button mt-3 mx-3" >
