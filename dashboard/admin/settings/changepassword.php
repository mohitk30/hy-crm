         ...
         <div id="main-container-div" class="d-flex flex-row">
                ...
                <div id="right-container">
                                    ...
                                    <div class="right-container-header" >
                                          <div class="username-position">Home > Settings > Change Password</div>
                                                                          ...
                                                                          <div>
                                                                                <div class="input-group mb-3 mx-2  w-75">
                                                                                    <div class="input-group-prepend">
                                                                                      <span class="input-group-text" id="basic-addon3">New Password<span class="red-asterick" >*</span></span>
                                                                                    </div>
                                                                                    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                                                                                  </div>
                                                                                  <div class="input-group mb-3 mx-2  w-75">
                                                                                    <div class="input-group-prepend">
                                                                                      <span class="input-group-text" id="basic-addon3">Confirm Password<span class="red-asterick" >*</span></span>
                                                                                    </div>
                                                                                    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3">
                                                                                  </div>

                                                                                  <div class="line-div mt-3 mb-2"></div>
                                                                                   
                                                                                  <div class="save-button mx-2" >
